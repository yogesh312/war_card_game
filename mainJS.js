...
//here we have filling user and dealer array and passing values to JQKA
function lotocards() {
    ...
    // dealer chars for type of different cards
    ...
    // scores: for both dealer and user
